...
const ChooseRingSetting = () => {
  ...
  const { menuShopStyle } = useParams();

  var { trellisRing } = useParams();
  ...
  let checkedBridalSetsNew = checkedBridalSets?.toLowerCase() === "true";
    ...
    <>
      ...
      >
        ...
        <div className={`bredCramStyleFilter`}>
          ...
          {shapeName && (
            <div className={`breadCram `}>
              <Link to="javascript:void(0)" onClick={() => handleShapeRemove()}>
                {`Shape ` + shapeName}
                <span>
                  <IoClose />
                </span>

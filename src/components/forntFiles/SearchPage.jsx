                  ...
                  {shapeData.map((item) => {
                    return (
                      <div className="ss__list filter-groups">
                        ...
                        >
                          <LazyLoadImage width="auto"  height="auto"   effect="blur" src={item.icon} alt={item.shape} onError={handleError}/>
          ...
          <div className="bredCramStyleFilter">
            ...
            {metalColorName &&
              <div className="breadCram" >
                <Link to="#" onClick={() => handleRemoveColor(metalColorName)}>
                  {metalColorName}{" "}
                  <span>
                    <IoIosClose />
                  </span>
                        ...
                        <div className="main-common-active product-main-img">
                          <div className="all-img1 common-img defaultImg White">
                            <span className="common-stand-img-1">
                              <LazyLoadImage width="auto"  height="auto"   effect="blur"

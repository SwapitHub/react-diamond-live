...
import { addToCart, removeToWishlist } from "../../redux/action";
                                ...
                                return (
                                  <div class="wishlists-inner-row gemstone">
                                    <div class="whishlist-colum">
                                      ...
                                      <div class="top-whish-list">
                                        <Link
                                          to={`/gemstones-detail/?stock_num=${item.gemstone_id}`}
                                        >
                                          <img
                                            width="auto"
                                            height="auto"
                                ...
                                <div class="whishlist-colum">
                                  ...
                                  <div class="top-whish-list">
                                    <ul>
                                      {" "}
                                      <Link
                                        to={`/detail-wedding-band/${item.ring?.slug}?color=${item.active_color}&diamond_original=${item.ring_type}`}
                                      >
                                        <li
                                          className={
                                            item.active_color === white
                          ...
                          >
                            <div class="wishlists-inner-row gemstone">
                              <div class="whishlist-colum">
                                ...
                                <div class="caption">
                                  <Link
                                    to={`/detail-wedding-band/${item.ring?.slug}?color=${item.active_color}`}
                                    class="product-info"
                                  >
                                    <div class="headline" data-item="CYO Rings">
                                      {item.ring?.name}
                        ...
                        {item.product_type === "gemstone" && (
                          <div class="wishlists-inner-row gemstone">
                            <div class="whishlist-colum">
                              ...
                              <div class="top-whish-list">
                                <Link
                                  to={`/gemstones-detail/?stock_num=${item.item?.stock_num}`}
                                >
                                  <img
                                    width="auto"
                                    height="auto"
                          ...
                          <div class="wishlists-inner-row gemstone">
                            <div class="whishlist-colum">
                              ...
                              <div class="top-whish-list">
                                <ul>
                                  <Link
                                    to={`/detail-wedding-band/${item.ring?.slug}?color=${item.ring_color}&diamond_original=${item.ring_type}`}
                                  >
                                    <li
                                      className={
                                        item.ring_color === white
                              ...
                              <div class="caption">
                                <Link
                                  to={`/detail-wedding-band/${item.ring?.slug}?color=${item.ring_color}`}
                                  class="product-info"
                                >
                                  <div class="headline" data-item="CYO Rings">
                                    {item.ring?.name}

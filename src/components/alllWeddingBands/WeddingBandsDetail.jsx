...
import NewsLetter from "../AllRings/reusable_components/NewsLetter";
import { RingSizeChart } from "../AllRings/RingSizeChart";
...
export const WeddingBandsDetail = () => {
  ...
  const handleCreateAccount = async (
    ...
    const URL_2 = `${baseUrl}/cart?user_id=${user_id}&product_type=${formData.product_type}&ring_id=${formData.ring_id}&ring_color=${formData.ring_color}&img_sku=${formData.img_sku}&ring_price=${formData.ring_price}&ring_type=${formData.ring_type}&ring_size=${formData.ring_size}${formData.textEngraving ? `&engraving=${formData.textEngraving}`: ""}${formData.font_style ? `&font=${formData.font_style}`:""}`;
                  ...
                  <div className="singleProduct-text">
                    ...
                    <div className="shipping-add">
                      <ul>
                        ...
                        <li>
                          <Link to="#">Free Shipping, Free 30 Day Returns</Link>
                        </li>
                      </ul>
